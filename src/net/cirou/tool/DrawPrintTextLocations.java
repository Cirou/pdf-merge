...
public class DrawPrintTextLocations extends PDFTextStripper {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			document = PDDocument.load(new File("./res/qrcode/H88-MA-E-2430150_A.pdf"));

			DrawPrintTextLocations stripper = new DrawPrintTextLocations(document, "./res/qrcode/H88-MA-E-2430150_A.pdf");
